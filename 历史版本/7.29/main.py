...
class GameSymbol:
    ...
    def capture_weighted_car_coord(self, map_corners):
        ...
        return (round(weighted_x - 0.5, 2),round(weighted_y - 0.5, 2)), last_rectified_img
...
while True:
    ...
    if cmd == b'O':
        ...
        # box_blobs = img.find_blobs([ELEMENT["box"]["threshold"]],
        # pixels_threshold=100,
        # area_threshold=100,
        # merge=True,
        # margin=0)
        ...
        if symbolmap is None:
            ...
            continue
        car_grid_x = int(visual_ref[0] + 0.5)
        car_grid_y = int(visual_ref[1] + 0.5)
        ...
        continue
        # else:
        #     myuart.writeMmode(symbolmap=empty_map)
