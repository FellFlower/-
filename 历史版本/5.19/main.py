...
def detect_and_draw_car(img):
    ...
    if not head_blobs or not back_blobs:
        ...
        # 范围：-180 ~ 180
        # ==========================
        # img.draw_rectangle(b1.rect(), color=(255, 0, 0), thickness=1)
        # img.draw_rectangle(b1_core.rect(), color=(0, 255, 0), thickness=2)

        # img.draw_rectangle(b2.rect(), color=(255, 0, 0), thickness=1)
        # img.draw_rectangle(b2_core.rect(), color=(0, 255, 0), thickness=2)
        ...
        if coord is None:
            return None
        ax, ay = coord
        # print("y1:", y1, "y2:", y2, "dy:", dy, "angle:", car_angle)
        return (ax, ay)
